...
| | | |
| --- | --- | --- |
| ![Default](.github/screenshots/default.jpg)<br>`default` | ![Fraunces](.github/screenshots/fraunces.jpg)<br>[`fraunces`](https://fonts.google.com/specimen/Fraunces) | ![Bitcount](.github/screenshots/bitcount-prop-single.jpg)<br>[`bitcount-prop-single`](https://fonts.google.com/specimen/Bitcount+Prop+Single) |
...
- **`UnityLock`**: one lock screen, covering one monitor. Holds the two pages and handles the keyboard and the mouse.
- **`UnityLockDatetimePage`**: the first page. The wallpaper with the clock over it. Scroll down or press any key to leave it.
